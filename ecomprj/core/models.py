...
class Category(models.Model):
    ...
    def category_image(self):
        return mark_safe('<img src="%s" width="500" height="50" />' % (self.image.url))
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Brawlify")
    image = models.ImageField(upload_to=user_directory_path, default="vendor.jpg")
    description = models.TextField(null=True, blank=True, default="I am an Amazing Vendor")

    address = models.CharField(max_length=100, default="123 Main Street")
    contact = models.CharField(max_length=100, default="+78805534573")
    ...
    def vendor_image(self):
        return mark_safe('<img src="%s" width="90" height="90" />' % (self.image.url))
...
class Product(models.Model):
    ...
    def product_image(self):
        return mark_safe('<img src="/media/%s" width="100" height="70" />' % (self.image))
...
class CartOrderItems(models.Model):
    ...
    def order_img(self):
        return mark_safe('<img src="/media/%s" width="500" height="50" />' % (self.image))
